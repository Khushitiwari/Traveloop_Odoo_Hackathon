...
const DEFAULT_CITIES = [
  ...
  { name: 'Osaka', country: 'Japan', region: 'Asia', costIndex: 1.8, popularity: 90, description: 'Street food capital with modern energy and historic landmarks.' },
  { name: 'Seoul', country: 'South Korea', region: 'Asia', costIndex: 1.7, popularity: 92, description: 'Dynamic blend of palaces, K-culture, and city nightlife.' },
  ...
  { name: 'Thailand', country: 'Thailand', region: 'Asia', costIndex: 1.3, popularity: 86, description: 'Country-level destination option for broad Thailand planning.' },
  { name: 'Delhi', country: 'India', region: 'Asia', costIndex: 1.0, popularity: 91, description: 'Historic forts, markets, and rich North Indian culture.' },
  { name: 'Mumbai', country: 'India', region: 'Asia', costIndex: 1.2, popularity: 93, description: 'Coastal metropolis known for Bollywood and iconic landmarks.' },
  { name: 'Agra', country: 'India', region: 'Asia', costIndex: 0.9, popularity: 88, description: 'Home of the Taj Mahal and Mughal-era heritage sites.' },
  { name: 'Surat', country: 'India', region: 'Asia', costIndex: 0.9, popularity: 76, description: 'Bustling textile and diamond city with food culture.' },
  { name: 'Vadodara', country: 'India', region: 'Asia', costIndex: 0.9, popularity: 74, description: 'Cultural city with palaces, museums, and vibrant festivals.' },
  { name: 'Dumas', country: 'India', region: 'Asia', costIndex: 0.8, popularity: 65, description: 'Beachside destination near Surat, known for sunset views.' },
  { name: 'Pune', country: 'India', region: 'Asia', costIndex: 1.0, popularity: 84, description: 'Pleasant weather, forts, cafes, and weekend escapes.' },
  { name: 'Bangalore', country: 'India', region: 'Asia', costIndex: 1.1, popularity: 90, description: 'Garden city with tech hubs, breweries, and nearby hills.' },
