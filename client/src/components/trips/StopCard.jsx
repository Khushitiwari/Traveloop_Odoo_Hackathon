    ...
    <div className="bg-white rounded-2xl shadow-card p-5">
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex gap-2">
          <button onClick={onAddActivities} className="text-xs text-mint-600 font-medium hover:text-mint-800 bg-mint-50 hover:bg-mint-100 px-3 py-1.5 rounded-lg transition-colors">
            + Activities
          </button>
          <button onClick={onDelete} className="text-xs text-blush-500 font-medium hover:text-blush-700 bg-blush-50 hover:bg-blush-100 px-3 py-1.5 rounded-lg transition-colors">
            Remove
          </button>
        </div>
      </div>
